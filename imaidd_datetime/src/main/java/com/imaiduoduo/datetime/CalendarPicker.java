package com.imaiduoduo.datetime;
...
import com.imaiduoduo.datetime.calendars.DPCManager;
import com.imaiduoduo.datetime.entities.DPInfo;
import com.imaiduoduo.datetime.languages.DPLManager;
import com.imaiduoduo.datetime.themes.DPTManager;
import com.imaiduoduo.datetime.utils.SizeUtils;
...
//            y = rect.centerY() + Math.abs(mPaint.ascent()) - (mPaint.descent() - mPaint.ascent()) / 2F;
        ...
        if (isMonthFirstDay) {
            ...
            mPaint.setTextSize(SizeUtils.dp2px(getContext(), 13));
