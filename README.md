...
> 目前该库处于功能开发阶段，后期会将功能发布到Jfrog bintray,形成远程引用仓库 <br/>
...
###### 2020.10.14 新增「轮播广告条，滚动定位到图片取色并设置标题栏背景」
###### 2020.09.15 
###### 2020.08.26 新增「支持输入得Spinner」
###### 2020.08.22 新增「重启App」
###### 2020.08.20 新增「Tab锚点定位」，见ITabScrollActivity.java
###### 2020.08.05 新增「仿微信右上角弹窗」
###### 2020.07.20 时间日期 「仿美柚经期日历」「时间轴-日历+时间线」「时间轴-自定义时间线（recyclerview）」
###### 2020.07.18 多类型筛选菜单
