...
/**
 * @ClassName:  ISLPermanentStickyActivity
 * @Author: maiduoduo
 * @BLOG: https://blog.csdn.net/Maiduoudo
 * @Date: 2020/9/18
 * @des:  ScrollerLayout 布局吸顶常驻
 */
@Layout(R.layout.activity_scrollerlayout_permanentsticky)
@DarkStatusBarTheme(true)
public class ISLPermanentStickyActivity extends IBaseActivity {
