...
/**
 * @ClassName: IChartsDialActivity
 * @Author: maiduoduo
 * @BLOG: https://blog.csdn.net/Maiduoudo
 * @Date: 2021/2/19
 * @des: 表盘图
 */
@Layout(R.layout.activity_charts_dial)
@DarkStatusBarTheme(true)
public class IChartsDialActivity extends IBaseActivity {
    ...
    public void eventClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvTempControlView:
                jump(IChartsDialTempControlActivity.class);
                break;
