 ...
 */
public class HomeMultipleRecycleLongAdapter extends BaseMultiItemQuickAdapter<MainItemBean, BaseViewHolder> {
     ...
     */
    public HomeMultipleRecycleLongAdapter(Activity context, List<MainItemBean> data) {
        super(data);
