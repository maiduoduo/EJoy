...
/**
 * @ClassName:  ISLSinkStickyActivity
 * @Author: maiduoduo
 * @BLOG: https://blog.csdn.net/Maiduoudo
 * @Date: 2020/9/18
 * @des:  ScrollerLayout 布局吸顶下沉模式
 */
@Layout(R.layout.activity_scrollerlayout_sinksticky)
@DarkStatusBarTheme(true)
public class ISLSinkStickyActivity extends IBaseActivity {
