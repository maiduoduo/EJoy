...
public class SearchableListDialog extends DialogFragment implements
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        // Getting the item_check_to_correct_task inflater to inflate the view in an alert dialog.
        LayoutInflater inflater = LayoutInflater.from(getActivity());

        // Crash on orientation change #img_g
        // Change Start
        ...
        setData(rootView);
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(getActivity(),R.style.SearchableDialog);
        ...
        String _textHint = _strTextHint == null ? " " : _strTextHint;
        searchView.setQueryHint(_textHint);
...
//        }
    ...
    public void setSearchTextHint(String textHint) {
        _strTextHint = textHint;
    }
    ...
    private void setData(View rootView) {
        ...
        listAdapter = new ArrayAdapter(getActivity(), R.layout.item_dialog_searchable_list, items);
