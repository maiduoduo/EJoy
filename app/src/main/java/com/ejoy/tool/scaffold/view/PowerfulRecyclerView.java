...
import com.ejoy.tool.scaffold.utils.DisplayHelper;
...
public class PowerfulRecyclerView extends RecyclerView {
    ...
    public PowerfulRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        mDividerSize = ta.getDimensionPixelSize(R.styleable.PowerfulRecyclerView_dividerSize,  DisplayHelper.px2dp(mContext,1));
