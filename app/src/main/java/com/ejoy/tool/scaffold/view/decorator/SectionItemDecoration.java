...
public class SectionItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public SectionItemDecoration(Context context, List<CitysBean> data) {
        this.mData = data;
...
//        mBgColor = context.getResources().getColor(typedValue.resourceId);
        mBgColor = context.getResources().getColor(R.color.light_gray3);
...
//        mTextColor = context.getResources().getColor(typedValue.resourceId);
        mTextColor = context.getResources().getColor(R.color.black_33);
    ...
    public void setData(List<CitysBean> data) {
        this.mData = data;
    }
