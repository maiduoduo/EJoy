 ...
 */
public class EEditTextSearch extends AppCompatEditText {
        /**
        ...
        public EEditTextSearch(Context context) {
            super(context);
        ...
        public EEditTextSearch(Context context, AttributeSet attrs) {
            super(context, attrs);
            this.context = context;
            init();
        }

        public EEditTextSearch(Context context, AttributeSet attrs, int defStyleAttr) {
