 ...
 * Date:   2019/12/30
 * Des:    TODO:Grid可自定义分割线样式
 */
public class EGridDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public EGridDividerItemDecoration(Context context, int spanCount) {
        ...
        if (mDivider != null) {
            ...
            mDividerWidth = EDensityUtils.dp2px(context,1);
        }
    }
     ...
     * @param dividerWidth
     */
    public EGridDividerItemDecoration(Context context, int spanCount, int dividerWidth) {
