 ...
 * Des:    TODO:主题工具
 */
public final class EThemeUtils {
    ...
    public static ColorStateList getActionTextStateList(Context context, int newPrimaryColor) {
        final int fallBackButtonColor =
                EThemeUtils.resolveColor(context, android.R.attr.textColorPrimary);
        ...
        int[] colors = new int[]{EThemeUtils.adjustAlpha(newPrimaryColor, 0.4f), newPrimaryColor};
