...
import com.module.iviews.bottomsheet.custom.helpers.IMaxHeightRecyclerView;
import com.module.iviews.bottomsheet.custom.helpers.IViewGroupUtils;

import java.lang.ref.WeakReference;

@SuppressWarnings({"WeakerAccess", "unused"})
public class ICustomBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public ICustomBottomSheetBehavior() {
    }

    public ICustomBottomSheetBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public Parcelable onSaveInstanceState(CoordinatorLayout parent, V child) {
        return new ICustomBottomSheetBehavior.SavedState(super.onSaveInstanceState(parent, child), mState);
    }
    ...
    private boolean isTouchInChildBounds(ViewGroup parent, View child, MotionEvent ev) {
        return IViewGroupUtils.isPointInChildBounds(parent, child, (int) ev.getX(), (int) ev.getY());
    }
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, final V child, int layoutDirection) {
        ...
        IMaxHeightRecyclerView rv = child.findViewById(R.id.recyclerView);
