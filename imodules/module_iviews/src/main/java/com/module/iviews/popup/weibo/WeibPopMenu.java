 ...
 * Author： DINGCL
 * Date:   2016/5/10
 * Des:    TODO:Popmenu仿微博“+”弹出菜单
 */
public class WeibPopMenu {
    ...
    private WeibPopMenu(Builder builder) {
...
//        mGridLayout.setBackgroundColor(Color.parseColor("#f0ffffff"));
            ...
            subView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mPopMenuItemListener != null) {
                        mPopMenuItemListener.onItemClick(WeibPopMenu.this, position);
                    }
                    hide();
                }
            });
    ...
    public static class Builder {
        ...
        public WeibPopMenu build() {
            final WeibPopMenu popMenu = new WeibPopMenu(this);
            return popMenu;
        }
    }
