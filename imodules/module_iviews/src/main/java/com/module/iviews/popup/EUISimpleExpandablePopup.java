 ...
 * 简单的可伸缩弹窗
 */
public class EUISimpleExpandablePopup<T extends EUISimpleExpandablePopup> extends EUIExpandableListPopup {

    public EUISimpleExpandablePopup(Context context, List<ExpandableItem> data) {
        this(context, new EUISimpleExpandableListAdapter(data));
    }

    public EUISimpleExpandablePopup(Context context, ExpandableItem... data) {
        this(context, new EUISimpleExpandableListAdapter(data));
    }

    public EUISimpleExpandablePopup(Context context, EUISimpleExpandableListAdapter adapter) {
     ...
     * @return
     */
    public EUIExpandableListPopup setOnExpandableItemClickListener(final OnExpandableItemClickListener onExpandableItemClickListener) {
    ...
    @Override
    public EUISimpleExpandableListAdapter getAdapter() {
        return (EUISimpleExpandableListAdapter) mAdapter;
    }
    ...
    public interface OnExpandableItemClickListener {
         ...
         */
        void onExpandableItemClick(EUISimpleExpandableListAdapter adapter, ExpandableItem group, int groupPosition, int childPosition);
    }
