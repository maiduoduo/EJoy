...
/**
 * @ClassName:  IChartGestureListener
 * @Author: maiduoduo
...
public interface IChartGestureListener {
   ...
   */
  void onChartGestureStart(MotionEvent me, IStockChartTouchHelper.ChartGesture lastPerformedGesture);
   ...
   * @param lastPerformedGesture 最后的手势类型
   */
  void onChartGestureEnd(MotionEvent me, IStockChartTouchHelper.ChartGesture lastPerformedGesture);
