...
import com.module.ires.bean.utils.EFindViewUtil;
 ...
 */
public class ISimpleMultiAlertDialog extends BasisDialog<ISimpleMultiAlertDialog> {

    public ISimpleMultiAlertDialog(Context context) {
    ...
    public TextView getTitle() {
        return EFindViewUtil.getTargetView(mContentView, R.id.tv_titleAlertDialog);
    }
    ...
    public TextView getMessage() {
        return EFindViewUtil.getTargetView(mContentView, R.id.tv_messageAlertDialog);
    }
    ...
    public Button getButton(int witch) {
        return EFindViewUtil.getTargetView(mContentView, witch == DialogInterface.BUTTON_NEGATIVE ?
    ...
    public static class DividerQQBuilder extends DividerBuilder<DividerQQBuilder> {
        ...
        public DividerQQBuilder setTitleDividerResource(int res) {
            return setTitleDivider(EResUtils.getDrawable(mContext,res));
        }
        ...
        public DividerQQBuilder setTitleDividerHeightResource(int res) {
            return setTitleDividerHeight(EResUtils.getDimensionPixelSize(mContext,res));
        }
    ...
    protected static class DividerBuilder<T extends DividerBuilder> extends Builder<T> {
        ...
        public T setDividerResource(int res) {
            return setDivider(EResUtils.getDrawable(mContext,res));
        }
        ...
        public T setDividerWidthResource(int res) {
            return setDividerWidth(EResUtils.getDimensionPixelSize(mContext,res));
        }
        ...
        protected View getDivider(int w, int h, Drawable drawable) {
            ...
            setViewBackground(view, EResUtils.getNewDrawable(drawable));
            return view;
        }
        ...
        protected Drawable getButtonDrawable(int gravity) {
            ...
            Drawable drawable = EResUtils.getNewDrawable(mBackground);
            Drawable drawablePressed = EResUtils.getNewDrawable(mBackgroundPressed);
    ...
    private static abstract class Builder<T extends Builder> extends BasisBuilder<T> implements ICreateButtons {
        ...
        public Builder(Context context) {
            ...
            setBackgroundResource(R.color.colorAlertBg)
                    ...
                    .setPadding(EResUtils.getDimensionPixelSize(mContext,R.dimen.alert_padding));
        }
        ...
        public T setBackgroundPressedResource(int resId) {
            return setBackgroundPressed(EResUtils.getDrawable(mContext,resId));
        }
        ...
        public T setTitle(int resId) {
            return setTitle(EResUtils.getText(mContext,resId));
        }
        ...
        public T setTitleTextColorResource(int resId) {
            return setTitleTextColor(EResUtils.getColorStateList(mContext,resId));
        }
        ...
        public T setMessage(int resId) {
            return setMessage(EResUtils.getText(mContext,resId));
        }
        ...
        public T setMessageTextColorResource(int resId) {
            return setMessageTextColor(EResUtils.getColorStateList(mContext,resId));
        }
        ...
        public T setNegativeButton(int resId, DialogInterface.OnClickListener listener) {
            return setNegativeButton(EResUtils.getText(mContext,resId), listener);
        }
        ...
        public T setNegativeButtonTextColorResource(int resId) {
            return setNegativeButtonTextColor(EResUtils.getColorStateList(mContext,resId));
        }
        ...
        public T setNeutralButton(int resId, DialogInterface.OnClickListener listener) {
            return setNeutralButton(EResUtils.getText(mContext,resId), listener);
        }
        ...
        public T setNeutralButtonTextColorResource(int resId) {
            return setNeutralButtonTextColor(EResUtils.getColorStateList(mContext,resId));
        }
        ...
        public T setPositiveButton(int resId, DialogInterface.OnClickListener listener) {
            return setPositiveButton(EResUtils.getText(mContext,resId), listener);
        }
        ...
        public T setPositiveButtonTextColorResource(int resId) {
            return setPositiveButtonTextColor(EResUtils.getColorStateList(mContext,resId));
        }
        ...
        public ISimpleMultiAlertDialog create() {
            int margin = dp2px(16);
            View contentView = createContentView();
            mDialog = new ISimpleMultiAlertDialog(mContext);
            mDialog.setContentView(contentView);
            setDialog();
            mDialog.setGravity(Gravity.CENTER);
            mDialog.setMargin(margin, margin, margin, margin);
            return (ISimpleMultiAlertDialog) mDialog;
        }
