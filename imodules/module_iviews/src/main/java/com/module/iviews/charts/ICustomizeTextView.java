...
public class ICustomizeTextView extends View {
    /**
     * 测量文本对应的矩形尺寸
     */
    private Rect rect;
    ...
    public ICustomizeTextView(Context context) {
        this(context, null);
    }

    public ICustomizeTextView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ICustomizeTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
