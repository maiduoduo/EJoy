 ...
 * 简易的可伸缩列表适配器
 */
public class EUISimpleExpandableListAdapter extends BaseExpandableListAdapter {
    /**
     * 数据
     */
    ...
    private int mArrowUpResId = R.drawable.eui_ic_expand_arrow_up;
    private int mArrowDownResId = R.drawable.eui_ic_expand_arrow_down;

    public EUISimpleExpandableListAdapter(List<ExpandableItem> data) {
        mData = data;
    }

    public EUISimpleExpandableListAdapter(ExpandableItem... data) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.eui_layout_expand_group_item, parent, false);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.eui_layout_expand_child_item, parent, false);
            ...
            if (mPaddingLeftPx != 0) {
                int padding = EThemeUtils.resolveDimension(parent.getContext(), R.attr.eui_config_content_spacing_vertical);
    ...
    public EUISimpleExpandableListAdapter setPaddingLeftPx(int paddingLeftPx) {
        mPaddingLeftPx = paddingLeftPx;
        return this;
    }

    public EUISimpleExpandableListAdapter setPaddingLeftDp(Context context,int paddingLeftDp) {
     ...
     * @return
     */
    public EUISimpleExpandableListAdapter setArrowStyle(int arrowDownResId, int arrowUpResId) {
