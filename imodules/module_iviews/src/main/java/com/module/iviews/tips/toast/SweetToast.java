 ...
 *
 * 收藏自：https://www.jianshu.com/p/26dfafc5410f
 */
...
public final class SweetToast {
    ...
    public static SweetToast makeText(@NonNull Context context, CharSequence text, int duration) {
        try {
            ...
            View mView = inflater.inflate(R.layout.layout_sweettip_transient_notification, null);
            TextView mMessage = mView.findViewById(R.id.tv_sweet_message);
            mMessage.setText(text);
            sweetToast.mRootView = mView;
            sweetToast.mContentView = mView.findViewById(R.id.llToastContent);
    ...
    private static void initConfiguration(SweetToast sweetToast, int duration){
        try {
            ...
            params.x = 0;
            params.y = sweetToast.getContentView().getContext().getResources().getDimensionPixelSize(R.dimen.sweet_toast_y_offset);
...
//            params.type = WindowManager.LayoutParams.TYPE_SYSTEM_ALERT;
    ...
    private static ShapeDrawable getBackgroundDrawable(SweetToast sweetToast, @ColorInt int backgroundColor){
        try {
            ...
            Log.e(TAG1,"e:"+e.getLocalizedMessage()+":154");
        }
        return null;
    }
    */
    ...
    public SweetToast setAnimations(@AnimRes int animEnter, @AnimRes int animExit){
        try {
            ...
            Log.e(TAG1,"setAnimations ->  e:"+e.getLocalizedMessage());
            return this;
        }
    }
    ...
    public SweetToast setAnimations(Animation enter, Animation exit){
        ...
        <style name="Animation.Toast">
            <item name="windowEnterAnimation">@anim/anim_sweet_toast_enter</item>
            <item name="windowExitAnimation">@anim/anim_sweet_toast_exit</item>
        </style>
    ...
    public SweetToast layoutAbove(View targetView, int statusHeight){
        if(mContentView!=null){
            ...
            //必须保证指定View的顶部可见
            int screenHeight = TipsScreenUtil.getScreenHeight(mContentView.getContext());
                ...
                if(showEnabled){
                    try {
                        ...
                        if(animEnter == null || animExit == null){
                            Log.e(TAG1,"animEnter == null || animExit == null");
                            /**
                            ...
                            Log.e(TAG1,"mConfiguration.getParams().windowAnimations:"+mConfiguration.getParams().windowAnimations);
