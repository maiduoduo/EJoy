...
class HeaderLayout extends FrameLayout {
    ...
    private View mVHeaderLlContent;
    ...
    private void initView(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_one_refresh_header_view, this, false);
        addView(view);
        ...
        mVHeaderLlContent = view.findViewById(R.id.header_ll_content);
    ...
    public void setHeaderMsgGone(boolean isGone) {
        if (isGone){
            mVHeaderLlContent.setVisibility(GONE);
        }else {
            mVHeaderLlContent.setVisibility(VISIBLE);
        }
    }
