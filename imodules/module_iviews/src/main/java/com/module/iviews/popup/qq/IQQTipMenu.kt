 ...
 */
class IQQTipMenu(val context: Context, val clickType: Int = TYPE_LONG_CLICK, val cornerPosition: Int = CORNER_POSITION_TOP) {
    ...
    private var popupMenuListener: IQQPopupMenuListener? = null
    ...
    fun bind(anchorView: View, menus: List<String>, popupMenuListener: IQQPopupMenuListener?) {
