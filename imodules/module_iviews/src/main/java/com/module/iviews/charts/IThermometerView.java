...
/**
 * @ClassName:  IThermometerView
 * @Author: maiduoduo
 * @BLOG: https://blog.csdn.net/Maiduoudo
 * @Date: 2018/7/20
 * @des: 自定义控件，温度计/体温计
 */
public class IThermometerView extends View {
    ...
    public IThermometerView(Context context) {
        super(context);
        init(null);
    }

    public IThermometerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public IThermometerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    public IThermometerView(Context context, ThermometerBuilder builder) {
        super(context);
    ...
    private void init(AttributeSet attrs) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.IThermometerView);
        viewBg = typedArray.getColor(R.styleable.IThermometerView_viewBg, Color.parseColor("#F5F5F5"));
        unitTextSize = typedArray.getDimension(R.styleable.IThermometerView_unitTextSize, 36f);
        unitTextColor = typedArray.getColor(R.styleable.IThermometerView_unitTextColor, Color.parseColor("#787878"));
        scaleTextSize = typedArray.getDimension(R.styleable.IThermometerView_scaleTextSize, 18f);
        scaleTextColor = typedArray.getColor(R.styleable.IThermometerView_scaleTextColor, Color.parseColor("#464646"));
        maxScaleLineColor = typedArray.getColor(R.styleable.IThermometerView_maxScaleLineColor, Color.parseColor("#787878"));
        midScaleLineColor = typedArray.getColor(R.styleable.IThermometerView_midScaleLineColor, Color.parseColor("#A9A9A9"));
        minScaleLineColor = typedArray.getColor(R.styleable.IThermometerView_minScaleLineColor, Color.parseColor("#A9A9A9"));
        scaleLineWidth = typedArray.getFloat(R.styleable.IThermometerView_scaleLineWidth, 1.5f);
        maxLineWidth = typedArray.getFloat(R.styleable.IThermometerView_maxLineWidth, 70f);
        midLineWidth = typedArray.getFloat(R.styleable.IThermometerView_midLineWidth, 50f);
        minLineWidth = typedArray.getFloat(R.styleable.IThermometerView_minLineWidth, 40f);
        spaceScaleWidth = typedArray.getFloat(R.styleable.IThermometerView_spaceScaleWidth, 30f);
        thermometerBg = typedArray.getColor(R.styleable.IThermometerView_thermometerBg, Color.WHITE);
        thermometerShadowBg = typedArray.getColor(R.styleable.IThermometerView_thermometerShadowBg, Color.parseColor("#F0F0F0"));
        maxThermometerRadius = typedArray.getFloat(R.styleable.IThermometerView_maxThermometerRadius, 80f);
        minThermometerRadius = typedArray.getFloat(R.styleable.IThermometerView_minThermometerRadius, 40f);
        maxMercuryRadius = typedArray.getFloat(R.styleable.IThermometerView_maxMercuryRadius, 60f);
        minMercuryRadius = typedArray.getFloat(R.styleable.IThermometerView_minMercuryRadius, 20f);
        leftMercuryBg = typedArray.getColor(R.styleable.IThermometerView_leftMercuryBg, Color.parseColor("#FFE6E0"));
        rightMercuryBg = typedArray.getColor(R.styleable.IThermometerView_rightMercuryBg, Color.parseColor("#FDE1DE"));
        leftMercuryColor = typedArray.getColor(R.styleable.IThermometerView_leftMercuryColor, Color.parseColor("#FF8063"));
        rightMercuryColor = typedArray.getColor(R.styleable.IThermometerView_rightMercuryColor, Color.parseColor("#F66A5C"));
        maxScaleValue = typedArray.getFloat(R.styleable.IThermometerView_maxScaleValue, 42f);
        minScaleValue = typedArray.getFloat(R.styleable.IThermometerView_minScaleValue, 35f);
        curScaleValue = typedArray.getFloat(R.styleable.IThermometerView_curScaleValue, 35f);
        typedArray.recycle();
    ...
    public static class ThermometerBuilder {
        ...
        public IThermometerView builder() {
            return new IThermometerView(context, this);
        }
