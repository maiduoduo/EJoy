package com.module.iviews.behavior.mimusicbehavior;
...
public class FaceBehavior extends CoordinatorLayout.Behavior {
    ...
    public FaceBehavior(Context context, AttributeSet attrs) {
        ...
        topBarHeight= (int) context.getResources().getDimension(R.dimen.mi_top_bar_height)+statusBarHeight;
        contentTransY= (int) context.getResources().getDimension(R.dimen.mi_content_trans_y);
        downEndY= (int) context.getResources().getDimension(R.dimen.mi_content_trans_down_end_y);
        faceTransY= context.getResources().getDimension(R.dimen.mi_face_trans_y);

        //抽取图片资源的亮色或者暗色作为蒙层的背景渐变色
        Palette palette = Palette.from(BitmapFactory.decodeResource(context.getResources(), R.mipmap.bimg_behavior_jj))
                .generate();
...
//        child.findViewById(R.id.v_mask).setBackground(drawable);
    ...
    public boolean onDependentViewChanged(@NonNull CoordinatorLayout parent, @NonNull View child, @NonNull View dependency) {
        ...
        Log.e("behavior", "onDependentViewChanged  upPro: "+ upPro);
        iamgeview.setAlpha(1-upPro);
//        iamgeview.setAlpha(1);
