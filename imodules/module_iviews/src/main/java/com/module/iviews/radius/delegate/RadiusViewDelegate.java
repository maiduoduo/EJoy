...
import com.module.iviews.radius.RadiusSwitch;
...
//        this.mResourceUtil = new EResUtils(context);
    ...
    protected void initAttributes(Context context, AttributeSet attrs) {
        ...
        mRippleColor = mTypedArray.getColor(R.styleable.RadiusSwitch_rv_rippleColor, EResUtils.getColor(mContext,R.color.colorRadiusDefaultRipple));
