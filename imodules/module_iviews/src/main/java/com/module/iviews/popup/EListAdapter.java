 ...
 * @param <T>
 */
public abstract class EListAdapter<T> extends BaseAdapter {
    ...
    public EListAdapter(Context context, List<T> data) {
        mContext = context;
        setData(data);
    }

    public EListAdapter(Context context, T[] data) {
        mContext = context;
        setData(data);
    }
     ...
     * @return
     */
    public EListAdapter setSelectPosition(int selectPosition) {
