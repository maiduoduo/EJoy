...
public class DouyinCircleImageView extends AppCompatImageView {
    ...
    public DouyinCircleImageView(Context context) {
        super(context);
        init(context, null);
    }

    public DouyinCircleImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public DouyinCircleImageView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.DouyinCircleImageView);
            borderColor = array.getColor(R.styleable.DouyinCircleImageView_ease_border_color, borderColor);
            borderWidth = array.getDimensionPixelOffset(R.styleable.DouyinCircleImageView_ease_border_width, borderWidth);
            pressAlpha = array.getInteger(R.styleable.DouyinCircleImageView_ease_press_alpha, pressAlpha);
            pressColor = array.getColor(R.styleable.DouyinCircleImageView_ease_press_color, pressColor);
            radius = array.getDimensionPixelOffset(R.styleable.DouyinCircleImageView_ease_radius, radius);
            shapeType = array.getInteger(R.styleable.DouyinCircleImageView_es_shape_type, shapeType);
            array.recycle();
        }
