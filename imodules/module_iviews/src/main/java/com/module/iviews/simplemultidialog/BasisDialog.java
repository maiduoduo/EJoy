...
//                .setLogEnable(BuildConfig.DEBUG)
    ...
    public T setDragEnable(boolean enable) {
        ...
        if (mContentView != null) {
            DragLayout dragLayout = EFindViewUtil.getTargetView(mContentView, DragLayout.class);
            if (dragLayout != null) {
...
//        protected EResUtils mResourceUtil;
        ...
        public BasisBuilder(Context context) {
            mContext = context;
//            mResourceUtil = new EResUtils(mContext);
        }
        ...
        public T setBackgroundResource(int resId) {
            return setBackground(EResUtils.getDrawable(mContext,resId));
        }
        ...
        public T setBackgroundRadiusResource(int res) {
            return setBackgroundRadius(EResUtils.getDimension(mContext,res));
        }
        ...
        public T setElevationResoure(int res) {
            return setElevation(EResUtils.getDimension(mContext,res));
        }
        ...
        public T setMinWidthResource(int res) {
            return setMinWidth(EResUtils.getDimensionPixelSize(mContext,res));
        }
        ...
        public T setMinHeightResource(int res) {
            return setMinHeight(EResUtils.getDimensionPixelSize(mContext,res));
        }
        ...
        protected void setViewBackground(View view, Drawable drawable) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                view.setBackground(EResUtils.getNewDrawable(drawable));
            } else {
                view.setBackgroundDrawable(EResUtils.getNewDrawable(drawable));
            }
        }
