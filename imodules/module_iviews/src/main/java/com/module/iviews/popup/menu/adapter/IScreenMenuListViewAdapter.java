package com.module.iviews.popup.menu.adapter;
 ...
 * 筛选菜单adapter
 */
public class IScreenMenuListViewAdapter extends BaseAdapter {
    ...
    public IScreenMenuListViewAdapter(Activity context, List<FiltrateBean> dictList) {
        this.context = context;
        this.dictList = dictList;
        strokeColor = context.getResources().getColor(R.color.LGray3);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final ViewHolder vh;
        if (convertView == null) {
            convertView = View.inflate(context, R.layout.item_flow_listview_property, null);
            vh = new ViewHolder();
    ...
    private void setFlowLayoutData(final List<FiltrateBean.Children> childrenList, final SkuFlowLayout flowLayout) {
        ...
        for (int x = 0; x < childrenList.size(); x++) {
            CheckBox checkBox = (CheckBox) View.inflate(context, R.layout.item_flow_layout_bill, null);
