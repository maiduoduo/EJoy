package com.module.iviews.popup.blurPop;
 ...
 * ShadowBlurContainer
 */
public class ShadowBlurContainer extends LinearLayout {
	...
	public ShadowBlurContainer(Context context) {
		this(context, null);
	}

	public ShadowBlurContainer(Context context, @Nullable AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public ShadowBlurContainer(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
	...
	protected void init(AttributeSet attrs) {
		...
		if (attrs != null) {
			TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.ShadowBlurContainer);
            mShadowColor = ta.getColor(R.styleable.ShadowBlurContainer_sc_shadowColor, mShadowColor);
			ta.recycle();
		}
