package com.imaidd.citypicker.citywheel;

import android.content.Context;

import com.google.gson.Gson;
import com.google.gson.reflect.TypeToken;
import com.imaidd.citypicker.CityConstant;
...
public class CityParseHelper {
    ...
    public void initData(Context context) {
        ...
        String cityJson = jsonUtils.getJson(context, CityConstant.CITY_DATA);
...
//            List<ICityBean> cityNames = new ArrayList<>();
