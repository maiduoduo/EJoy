...
import transportmanager.com.imaiduoduo.datetime.R;

/**
 * 日期弹框
 */
public class DatePickerDialog11 extends Dialog {

    private static  int MIN_YEAR = 1900;
    private static  int MAX_YEAR = 2100;
    private Params params;

    public DatePickerDialog11(Context context, int themeResId) {
        super(context, themeResId);
    }

    private void setParams(DatePickerDialog11.Params params) {
        this.params = params;
    }
    ...
    public static class Builder {
        ...
        private final DatePickerDialog11.Params params;
        ...
        public Builder(Context context) {
            ...
            params = new DatePickerDialog11.Params();
        }
        ...
        public DatePickerDialog11 create() {
            final DatePickerDialog11 dialog = new DatePickerDialog11(context, params.shadow ? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
